...
import com.mobilleon.smspro.asynctasks.OAuthRequestTokenTask;
import com.mobilleon.smspro.asynctasks.RetrieveTwitterAccessTokenTask;
import com.mobilleon.smspro.asynctasks.TwitterAuthenticationTask;
import com.mobilleon.smspro.asynctasks.TwitterUpdateTask;
import com.mobilleon.smspro.facebook.FacebookConnector;
import com.mobilleon.smspro.library.facebook.utilities.SessionEvents;
import com.mobilleon.smspro.model.MyMessage;
import com.mobilleon.smspro.model.SMSProData;
...
public class ShareAndSaveActivity extends SherlockActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                Intent intent = new Intent(ShareAndSaveActivity.this, SMSProActivity.class);
    ...
    private void saveToSdCard(String messageHead, String messageBody) {
        if(checkExternalStorageState()){
            try
            {
                File SMSProFile = new File(Environment.getExternalStorageDirectory(), "SMSPro");
    ...
    private Handler mTwitterUpdateHandler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            SMSProData<MyMessage> responseData = (SMSProData<MyMessage>) msg.obj;
