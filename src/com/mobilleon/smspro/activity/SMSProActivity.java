...
import com.mobilleon.smspro.adapters.MessageAdapter;
 ...
 *
 */
public class SMSProActivity extends SherlockListActivity implements OnSharedPreferenceChangeListener, OnQueryTextListener {
    ...
    private String TAG = SMSProActivity.class.getSimpleName();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case 5:
                Intent preferencesActivity = new Intent(getBaseContext(), SMSProSettingsActivity.class);
                startActivity(preferencesActivity);
                break;
                
            case 6:
                Intent intent;
                intent = new Intent(SMSProActivity.this, AboutActivity.class);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Intent shareIntent =  new Intent(SMSProActivity.this, ShareAndSaveActivity.class);
