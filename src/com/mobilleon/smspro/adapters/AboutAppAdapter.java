...
import com.mobilleon.smspro.view.ViewHolder;
...
public class AboutAppAdapter extends BaseAdapter{
    ...
    public AboutAppAdapter(Context context, List<AboutAppAuthorItem> aboutItems) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.about_app_list_item, null); 
            
            holder.mAboutItemHeader =  ((TextView) convertView.findViewById(R.id.about_item_heading));
            holder.mAboutItemDescription =  ((TextView) convertView.findViewById(R.id.about_item_desc));
            holder.mImageView = ((ImageView) convertView.findViewById(R.id.about_item_icon));            
