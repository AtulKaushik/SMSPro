...
package com.mobilleon.smspro.asynctasks;
...
public class MessageExportTask extends AsyncTask<MessageOperationRequest, Void, Boolean> {
    ...
    protected void onPostExecute(Boolean result) {
        ...
        SMSProData<MyMessage> resultData = new SMSProData<MyMessage>();
    ...
    private boolean checkExistingMails(Folder target, String subject, String textBody) {
